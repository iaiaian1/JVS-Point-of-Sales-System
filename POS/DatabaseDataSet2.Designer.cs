...
namespace POS {
    ...
    public partial class DatabaseDataSet2 : global::System.Data.DataSet {
        ...
        public partial class InventoryDataTable : global::System.Data.TypedTableBase<InventoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public InventoryRow AddInventoryRow(string Name, int Price, int Pieces) {
...
namespace POS.DatabaseDataSet2TableAdapters {
    ...
    public partial class InventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Inventory] WHERE (([Id] = @Original_Id) AND ([Name] = @Origina" +
                "l_Name) AND ([Price] = @Original_Price) AND ([Pieces] = @Original_Pieces))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Inventory] ([Name], [Price], [Pieces]) VALUES (@Name, @Price, " +
                "@Pieces);\r\nSELECT Id, Name, Price, Pieces FROM Inventory WHERE (Id = SCOPE_IDENT" +
                "ITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Inventory] SET [Name] = @Name, [Price] = @Price, [Pieces] = @Pieces WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Price] = @Original_Price) AND ([Pieces] = @Original_Pieces));
SELECT Id, Name, Price, Pieces FROM Inventory WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Price, Pieces FROM dbo.Inventory";
        ...
        public virtual int Fill(DatabaseDataSet2.InventoryDataTable dataTable) {
        ...
        public virtual DatabaseDataSet2.InventoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet2.InventoryDataTable dataTable = new DatabaseDataSet2.InventoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet2.InventoryDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Price, int Original_Pieces) {
        ...
        public virtual int Insert(string Name, int Price, int Pieces) {
            if ((Name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(Pieces));
        ...
        public virtual int Update(string Name, int Price, int Pieces, int Original_Id, string Original_Name, int Original_Price, int Original_Pieces, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Pieces));
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_Pieces));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Price, int Pieces, int Original_Id, string Original_Name, int Original_Price, int Original_Pieces) {
            return this.Update(Name, Price, Pieces, Original_Id, Original_Name, Original_Price, Original_Pieces, Original_Id);
        }
    }
