...
namespace POS {
    ...
    public partial class DatabaseDataSet8 : global::System.Data.DataSet {
        ...
        public partial class ShoppingCartDataTable : global::System.Data.TypedTableBase<ShoppingCartRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ShoppingCartRow AddShoppingCartRow(string Name, int Price, int Quantity) {
        ...
        public partial class ShoppingCartRow : global::System.Data.DataRow {
            ...
            public string Name {
                get {
                    return ((string)(this[this.tableShoppingCart.NameColumn]));
                }
                set {
                    this[this.tableShoppingCart.NameColumn] = value;
                }
            }
            ...
            public int Price {
                get {
                    return ((int)(this[this.tableShoppingCart.PriceColumn]));
                }
                set {
...
namespace POS.DatabaseDataSet8TableAdapters {
    ...
    public partial class ShoppingCartTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[ShoppingCart] WHERE (([Id] = @Original_Id) AND ([Name] = @Orig" +
                "inal_Name) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity)" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[ShoppingCart] ([Name], [Price], [Quantity]) VALUES (@Name, @Pr" +
                "ice, @Quantity);\r\nSELECT Id, Name, Price, Quantity FROM ShoppingCart WHERE (Id =" +
                " SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ShoppingCart] SET [Name] = @Name, [Price] = @Price, [Quantity] = @Quantity WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity));
SELECT Id, Name, Price, Quantity FROM ShoppingCart WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Price, Quantity FROM dbo.ShoppingCart";
        ...
        public virtual int Fill(DatabaseDataSet8.ShoppingCartDataTable dataTable) {
        ...
        public virtual DatabaseDataSet8.ShoppingCartDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet8.ShoppingCartDataTable dataTable = new DatabaseDataSet8.ShoppingCartDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet8.ShoppingCartDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Price, int Original_Quantity) {
        ...
        public virtual int Update(string Name, int Price, int Quantity, int Original_Id, string Original_Name, int Original_Price, int Original_Quantity, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Price, int Quantity, int Original_Id, string Original_Name, int Original_Price, int Original_Quantity) {
            return this.Update(Name, Price, Quantity, Original_Id, Original_Name, Original_Price, Original_Quantity, Original_Id);
        }
    }
